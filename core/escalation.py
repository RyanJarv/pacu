...
from principalmapper.graphing.edge_identification import LambdaEdgeChecker
from principalmapper.graphing.lambda_edges import EdgeChecker
from principalmapper.querying.local_policy_simulation import resource_policy_authorization, ResourcePolicyEvalResult
from principalmapper.util import arns


class Lambda(ResouceChecker):
...
class PrivEscalation(Edge):
    def __init__(self, source: Node, destination: Node, escalate_func: typing.Callable):
        super().__init__(self, source, destination, str(escalate_func))
    ...
    def run(self) -> bool:
        self.escalate_func(self)


class LambdaEscalation(LambdaEdgeChecker):
    """Class for identifying if Lambda can be used by IAM principals to gain access to other IAM principals."""
